...
# Evaluate normality
p1 = ggplot(data = out_log, aes(x = .std.resid)) +
...
p2 = ggplot(data = out_quad, aes(x = .std.resid)) +
  stat_density_confidence(model = "normal") +
  stat_density(geom = "line") +
  theme_light() +
  xlab("Standardized residuals") +
...
# Evaluate avg resid = 0, homoskedasticity
p3 = ggplot(data = out_log, aes(x = .fitted, y = .std.resid)) +
  geom_point() +
  geom_smooth() +
  geom_hline(yintercept = 0) +
  theme_light() +
...
p4 = ggplot(data = out_quad, aes(x = .fitted, y = .std.resid)) +
  geom_point() +
  geom_smooth() +
  geom_hline(yintercept = 0) +
  theme_light() +
