...
- Download and read through the [course syllabus](https://github.com/zief0002/gentrified-ladybug/raw/main/syllabus/s22-8252-syllabus.pdf)
...
- Download the [s22-00-rmarkdown directory](https://github.com/zief0002/gentrified-ladybug/raw/main/docs/notes/s22-00-rmarkdown.zip) and unzip it. This directory includes class notes and examples of several R Markdown documents.
...
<!-- - [<span class="fa fa-file-pdf" style="color: #ff2600; font-size: 17px;"></span> Knitting to PDF [Notes]](https://github.com/zief0002/gentrified-ladybug/raw/main/notes/rmarkdown/s21-knitting-to-pdf.pdf) -->
<!-- - [<span class="fa fa-file-pdf" style="color: #ff2600; font-size: 17px;"></span> Slides with xaringan [Notes]](https://github.com/zief0002/gentrified-ladybug/raw/main/notes/rmarkdown/s21-slides-with-xaringan.pdf) -->
