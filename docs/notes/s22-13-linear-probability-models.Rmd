...
- [[CSV]](https://raw.githubusercontent.com/zief0002/epsy-8252/master/data/graduation.csv)
- [[Data Codebook]](http://zief0002.github.io/epsy-8252/codebooks/graduation.html)
...
```{r fig.cap='Barplot showing graduation status for the sample.'}
...
```{r fig.cap='Proportion of students who graduate conditional on ACT score. Size of the dot is proportional to sample size. The regression smoother (solid, blue line) and loess smoother (dashed, red line) are based on the raw data.'}
# Scatterplot
...
```{r fig.cap='Scatterplot of whether a student graduated versus ACT score. The regression smoother (blue, solid line) and loess smoother (red, dashed line) shows the positive relationship between ACT score and the proportion of students who obtain their degree.'}
# Scatterplot
