...
```{r fig.width=8, fig.height=4, out.width='80%', fig.cap='LEFT: Negative quadratic function of x. RIGHT: Logarithmic function of x.'}
fig_01 = data.frame(
...
```{r fig.width=8, fig.height=4, out.width='80%', fig.cap="Density plot of the median SAT scores (LEFT) and the base-2 log-transformed median SAT scores (RIGHT).", class.source = 'fold-hide'}
...
```{r fig.cap='Comparison of the quadratic polynomial (blue, dashed line) and logarithmic (red, solid line) functions of X.', class.source = 'fold-hide'}
...
```{r fig.width=8, fig.height=8, out.width='80%', fig.cap="Residual plots for the log model and quadratic model.", class.source = 'fold-hide'}
# Augment the model
out_log = augment(lm.log)
