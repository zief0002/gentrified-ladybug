...
In this set of notes, we will use data from the file *minneapolis.csv*.

- [minneapolis.csv](https://raw.githubusercontent.com/zief0002/epsy-8252/master/data/minneapolis.csv)
- [Codebook](http://zief0002.github.io/epsy-8252/codebooks/minneapolis.html)
...
```{r fig.height=10, fig.width=10, out.width='90%', fig.cap='Scatterplots of the standardized residuals versus the fitted values for 22 students.'}
